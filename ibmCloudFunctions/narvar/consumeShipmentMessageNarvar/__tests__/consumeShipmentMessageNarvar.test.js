...
describe('parseShipmentMessage', () => {
  ...
  it('inbound jesta message transformed correctly for bopis orders', async () => {
    expect(parseShipmentMessage(validBopisParams.messages[0])).toEqual({"order_info": {"attributes": {"orderLastModifiedDate": null}, "order_date": "2001-09-09T01:46:40.000Z", "order_items": [{"attributes": {"deliveryItemLastModifiedDate": "2001-09-09T01:46:40.000Z", "orderItemLastModifiedDate": null, "barcode": "barcodeNumber"}, "fulfillment_type": "BOPIS", "item_id": "extRefId", "name": "descEng", "sku": "sku"}], "order_number": "67897", "pickups": [{"attributes": {"deliveryLastModifiedDate": "2001-09-09T01:46:40.000Z", "extRefId-deliveryItemLastModifiedDate": "2001-09-09T01:46:40.000Z"}, "carrier": undefined, "id": "shipmentId", "items_info": [{"item_id": "extRefId", "quantity": 1, "sku": "sku"}], "ship_date": "2001-09-09T01:46:40.000Z", "status": {"code": undefined, "date": "2001-09-09T01:46:40.000Z"}, "store": {"id": "siteId",  "address": {"city": "city", "country": "countryId", "state": "stateId", "street_1": "address1", "street_2": "address2", "zip": "zipCode"}, "name": "", "phone_number": "homePhone"}, "tracking_number": "trackingNumber", "type": "BOPIS"}]}})
  });
});
...
describe('mergeNarvarOrderWithDeliveries', () => {
  ...
  it('merge inbound order with narvar order but the narvar order has newer pickups; should not update the pickups but update the rest', () => {
    ...
    expect(result).toEqual({"order_info": {"attributes": {"orderLastModifiedDate": 1000000000001}, "order_date": "2001-09-09T01:46:40.000Z", "order_items": [{"attributes": {"deliveryItemLastModifiedDate": 1000000000001, "orderItemLastModifiedDate": 1000000000001}, "fulfillment_type": "BOPIS", "item_id": "extRefId", "name": "descEng", "sku": "sku"}], "order_number": "67897", "pickups": [{"attributes": {"1-deliveryItemLastModifiedDate": 1000000000000, "deliveryLastModifiedDate": "2001-09-09T01:46:40.000Z", "extRefId-deliveryItemLastModifiedDate": "2001-09-09T01:46:40.000Z"}, "carrier": undefined, "id": "shipmentId", "items_info": [{"item_id": "extRefId", "quantity": 1, "sku": "sku"}], "ship_date": "2001-09-09T01:46:40.000Z", "status": {"code": undefined, "date": "2001-09-09T01:46:40.000Z"}, "store": {"id": "siteId", "address": {"city": "city", "country": "countryId", "state": "stateId", "street_1": "address1", "street_2": "address2", "zip": "zipCode"}, "name": "", "phone_number": "homePhone"}, "tracking_number": "trackingNumber", "type": "BOPIS"}], "shipments": undefined}})
  });
});
